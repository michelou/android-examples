...
import android.support.v4.app.{Fragment, FragmentActivity, FragmentManager,
                               FragmentPagerAdapter, ListFragment}
...
class FragmentPagerSupport extends FragmentActivity {
  import FragmentPagerSupport._  // companion object
...
object FragmentPagerSupport {
  private final val NUM_ITEMS = 10

  private class MyAdapter(fm: FragmentManager) extends FragmentPagerAdapter(fm) {
    override def getCount: Int = NUM_ITEMS
    override def getItem(position: Int): Fragment =
      ArrayListFragment.newInstance(position)
  }

  private object ArrayListFragment {
    /**
