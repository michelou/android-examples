===============================================================================
     ...
     and adapted from the "Busy Coder's Guide to Android Development" book
===============================================================================

This document describes code examples written in Scala and adapted from the
Java examples available together with the "Hello Android!" book published by
The Pragmatic Bookshelf (http://www.commmonsware.com/Android/).
The source code may not be used to create training material, courses, books,
