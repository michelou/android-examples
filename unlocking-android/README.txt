...
virtual device) :
   ...
   unlocking-android> emulator -no-boot-anim -no-jni -avd API_10 &

Then we move for instance to the "BounceyBall" project directory and execute
